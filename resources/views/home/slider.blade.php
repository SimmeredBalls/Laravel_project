<section class="banner_main">
   ...
   <!-- Booking overlay (optional container left as is for layout) -->
   <div class="booking_ocline">
      <div class="container">
         <div class="row">
            <div class="col-md-5">
               <div class="book_room">
                  <h1>Welcome to Roblax Hotel</h1>
                  <form class="book_now">
                     <div class="row">
                        <div class="col-md-12">
                           <a class="book_btn" href="{{ route('our_room.details') }}" style="text-align: center;">Book Now</a>
                        </div>
                     </div>
                  </form>
               </div>
